...
- `dgd\docs\architecture` folder with this version's `dgd\docs\architecture\v0.02_ARCHITECTURE.md` and `dgd\docs\architecture\v0.02_SPECIFICATION.md` files. 
- You must write your technical specification and plan referencing all of the key arch, spec, and design language files, ensuring a smartly implemented V0.2.0. 
