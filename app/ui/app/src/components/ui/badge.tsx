...
const colors = {
  ...
  accent:
    "bg-dojo-accent-primary/20 text-dojo-accent-primary group-data-hover:bg-dojo-accent-primary/30 dark:bg-dojo-accent-primary/20 dark:text-dojo-accent-tertiary dark:group-data-hover:bg-dojo-accent-primary/30",
};
