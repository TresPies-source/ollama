...
var (
	pidFile       = filepath.Join(os.Getenv("HOME"), "Library", "Application Support", "DojoGenesis", "dojogenesis.pid")
	serverLogPath = filepath.Join(os.Getenv("HOME"), ".dojogenesis", "logs", "server.log")
)
